...
class ServerListAdapter extends RecyclerView.Adapter<ServerListAdapter.ViewHolder>  {
     ...
     */
    ServerListAdapter(Context context, ArrayList<Server> serverData) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
          ...
          //  Intent detailIntent = new Intent(mContext, DetailActivity.class);
            //detailIntent.putExtra("server", current.getEndpoint());
            Toast.makeText(mContext, current.getEndpoint(), Toast.LENGTH_SHORT).show();
